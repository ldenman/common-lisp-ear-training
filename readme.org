...
* Issues
  ...
  - portmidi seems flakey in that sometimes the midi devices can't connect
    #+begin_example
      PortMidi: `Host error'
	 [Condition of type SIMPLE-ERROR]
      ...
      Restarts:
       ...
       2: [ABORT] abort thread (#<THREAD "repl-thread" RUNNING {10026C1DD3}>)

      Backtrace:
	0: ((:METHOD CFFI:TRANSLATE-FROM-FOREIGN (T PORTMIDI::PM-ERROR-TYPE)) -10000 #<unused argument>) [fast-method]
	1: (PORTMIDI:WRITE-MIDI #.(SB-SYS:INT-SAP #X7F552402ADA0) #.(SB-SYS:INT-SAP #X7F5531BF7FF0))
	2: (PORTMIDI:WRITE-SHORT-MIDI #.(SB-SYS:INT-SAP #X7F552402ADA0) 0 5261456)
	3: (SB-INT:SIMPLE-EVAL-IN-LEXENV (LD-MUSIC:SETUP-MIDI) #<NULL-LEXENV>)
	4: (EVAL (LD-MUSIC:SETUP-MIDI))
       --more--
    #+end_example
    #+begin_example
	 ...
	 [Condition of type SIMPLE-ERROR]
      ...
      Backtrace:
	0: ((:METHOD CFFI:TRANSLATE-FROM-FOREIGN (T PORTMIDI::PM-ERROR-TYPE)) -9995 #<unused argument>) [fast-method]
	1: (PORTMIDI:CLOSE-MIDI #.(SB-SYS:INT-SAP #X7F552402ADA0))
	2: (LD-MUSIC::PM-TERMINATE)
	3: (LD-MUSIC::PM-RELOAD 2)
	4: (LD-MUSIC:SETUP-MIDI)
	5: (SB-INT:SIMPLE-EVAL-IN-LEXENV (LD-MUSIC:SETUP-MIDI) #<NULL-LEXENV>)
	6: (EVAL (LD-MUSIC:SETUP-MIDI))
       --more--
